...
function drawGrowthChart(data){
  ...
  data.forEach((item, index) => {
    ...
    ctx.fillRect(x - barWidth / 2, baseY - principalHeight, barWidth, principalHeight);

    ctx.fillStyle = isDark ? "#3fb950" : "#2da44e";
    ctx.fillRect(x - barWidth / 2, baseY - principalHeight - interestHeight, barWidth, interestHeight);
  });
